...
extern "C" {
  ...
  uint64_t uniffi_ads_client_fn_clone_mozadstelemetry(uint64_t, RustCallStatus*);
  void uniffi_ads_client_fn_free_mozadstelemetry(uint64_t, RustCallStatus*);
  ...
  void uniffi_ads_client_fn_method_mozadstelemetry_record_build_cache_error(uint64_t, RustBuffer, RustBuffer, RustCallStatus*);
  void uniffi_ads_client_fn_method_mozadstelemetry_record_client_error(uint64_t, RustBuffer, RustBuffer, RustCallStatus*);
  void uniffi_ads_client_fn_method_mozadstelemetry_record_client_operation_total(uint64_t, RustBuffer, RustCallStatus*);
  void uniffi_ads_client_fn_method_mozadstelemetry_record_deserialization_error(uint64_t, RustBuffer, RustBuffer, RustCallStatus*);
  void uniffi_ads_client_fn_method_mozadstelemetry_record_http_cache_outcome(uint64_t, RustBuffer, RustBuffer, RustCallStatus*);
...
extern "C" uint64_t callback_clone_ads_client_moz_ads_telemetry(uint64_t uniffiHandle);
...
class FfiValueObjectHandleAdsClientMozAdsTelemetry {
 ...
 public:
  ...
  static FfiValueObjectHandleAdsClientMozAdsTelemetry FromRust(uint64_t aValue) {
